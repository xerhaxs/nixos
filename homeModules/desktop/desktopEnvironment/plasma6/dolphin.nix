...
{
  options.homeManager = {
    desktop.desktopEnvironment.plasma6.dolphin = {
      enable = lib.mkOption {
        type = lib.types.bool;
        default = false;
        example = true;
    ...
    xdg.dataFile."kxmlgui5/dolphin/dolphinui.rc".text = ''
      ...
      <gui name="dolphin" version="48">
       ...
       <ActionProperties scheme="Default">
        ...
        <Action name="deletefile" priority="0"/>
        ...
        <Action name="movetotrash" priority="0"/>
        <Action name="new_menu" priority="0"/>
        <Action name="show_information_panel" priority="0"/>
