  ...
  config = lib.mkIf config.homeManager.desktop.desktopEnvironment.plasma5.plasma5.enable {
    ...
    programs.plasma = {
      ...
      shortcuts = {
        ...
        "org.kde.krunner.desktop"."_launch" = ["Meta+Space" "Meta+R" "Alt+Space" "Alt+F2" "Search"];
        ...
        "org.kde.spectacle.desktop"."_launch" = "Shift+Print";
      ...
      configFile = {
        ...
        "kwinrc"."NightColor"."LongitudeAuto" = 8.10;
