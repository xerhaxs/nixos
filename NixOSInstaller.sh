...
nix run github:nix-community/disko -- --mode disko --flake github:xerhaxs/nixos#NixOS-Server --extra-experimental-features --accept-flake-config
...
nixos-install --no-root-passwd --impure --flake $FLAKE_HOST --accept-flake-config
