...
nix --experimental-features "nix-command flakes" run github:nix-community/disko -- --mode disko --flake github:xerhaxs/nixos#NixOS-Server --extra-experimental-features
