      ...
      spectacle = super.kdePackages.spectacle.overrideAttrs (oldAttrs: rec {
        ...
        postInstall = ''
          wrapProgram $out/bin/spectacle \
            --prefix PATH : ${super.tesseract5.override {
              enableLanguages = [ "eng" "osd" "deu" ];
            }}/bin \
            --set TESSDATA_PREFIX ${super.tesseract5.override {
              enableLanguages = [ "eng" "osd" "deu" ];
            }}/share/tessdata \
            --prefix LD_LIBRARY_PATH : ${super.tesseract5.override {
              enableLanguages = [ "eng" "osd" "deu" ];
            }}/lib
        '';
      });
